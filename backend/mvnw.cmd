...
@REM Trailing backslash before a quote breaks -D properties on Windows
...
:execute
@REM work around JBEAP-8937 (on Windows 10+)
...
@REM check for post script, once with non-exe extension
